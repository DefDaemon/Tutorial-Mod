...
import com.defdaemon.tutorialmod.common.block.KaupenAltarBlock;
...
public class KJTeleporter implements ITeleporter
{
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld, float yaw, Function<Boolean, Entity> repositionEntity)
    {
        ...
        if (insideDimension) {
            ...
            if (doSetBlock)
            {
                destinationWorld.setBlockAndUpdate(destinationPos, ModBlocks.KAUPEN_ALTAR.get().defaultBlockState());
            }
        }
        return entity;
    }
